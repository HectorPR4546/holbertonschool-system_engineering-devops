...
- [`web_infrastructure_design/0-simple_web_stack`](web_infrastructure_design/0-simple_web_stack): walkthrough of the single-server setup.
- [`web_infrastructure_design/Task_0_Diagram.mmd`](web_infrastructure_design/Task_0_Diagram.mmd): Mermaid diagram that shows the flow.

## Task 1 - Distributed web infrastructure
- [`web_infrastructure_design/1-distributed_web_infrastructure`](web_infrastructure_design/1-distributed_web_infrastructure): notes on the HAProxy + dual-server design.
- [`web_infrastructure_design/Task_1_Diagram.mmd`](web_infrastructure_design/Task_1_Diagram.mmd): Mermaid flowchart for the distributed stack.
